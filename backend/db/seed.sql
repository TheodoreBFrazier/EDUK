...
', 'Scholarship', ARRAY [ 'highschool','college' , 'continue learning' ], 'N/A', 'N/A', 'https://www.salliemae.com/about/scholarship-opportunities/', true),
...
('HOPE Program', 'The Hope Program providing low-income individuals (ages 18+) seeking full-time employment with training programs remotely in conflict management, customer service, interviewing, career exploration, computer training and other classes.', 'Program', ARRAY [ 'college' , 'continue learning' ], 'N/A', 'N/A', 'https://www.thehopeprogram.org/', true),
('NEW', 'An organization preparing women ages 18+ for careers in construction and other trade industries through classroom and hands-on training; counseling; and job placement assistance.', 'Program', ARRAY [ 'college' , 'continue learning' ], 'N/A', 'N/A', 'https://www.new-nyc.org/', true),
('Chinese-American Planning Council', 'A center providing adults ages 18+ with vocational training in hospitality careers; job placement assistance; ESL classes; and a walk-in career center.', 'Program', ARRAY [ 'college' , 'continue learning' ], 'N/A', 'N/A', 'https://www.cpc-nyc.org/programs', true),
